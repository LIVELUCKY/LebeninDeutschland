...
import com.livelucky.lebenindeutschland.domain.use.GetAttemptsByCategory
import com.livelucky.lebenindeutschland.domain.use.GetRightTimesByCategory
...
object AppModule {
    ...
    fun provideProvider(repository: QuestionRepo): Provider {
        return Provider(
            ...
            getAttemptsByCategory = GetAttemptsByCategory(repository),
            getRightTimesByCategory = GetRightTimesByCategory(repository)
        )
    }
